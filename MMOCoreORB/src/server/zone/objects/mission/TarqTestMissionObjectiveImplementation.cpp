/*
 * TarqTestMissionObjectiveImplementation.cpp
 *
...
void TarqTestMissionObjectiveImplementation::setLairTemplateToSpawn(const String& sp) {
	lairTemplate = sp;
}
...
void TarqTestMissionObjectiveImplementation::activate() {
...
Vector3 TarqTestMissionObjectiveImplementation::findValidSpawnPosition(Zone* zone) {
	Vector3 position;
	ManagedReference<MissionObject*> mission = this->mission.get();
...
void TarqTestMissionObjectiveImplementation::spawnLair() {
...
void TarqTestMissionObjectiveImplementation::abort() {
...
void TarqTestMissionObjectiveImplementation::complete() {
	MissionObjectiveImplementation::complete();
}

int TarqTestMissionObjectiveImplementation::notifyObserverEvent(MissionObserver* observer, uint32 eventType, Observable* observable, ManagedObject* arg1, int64 arg2) {
...
Vector3 TarqTestMissionObjectiveImplementation::getEndPosition() {
	ManagedReference<MissionObject*> mission = this->mission.get();
